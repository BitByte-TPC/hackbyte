  ...
  return (
    <div className="w-full flex flex-col justify-center items-center gap-16 relative">
      ...
      <div className="bg-white rounded-[32px] absolute top-0 w-[80%] md:h-[500px] lg:h-[550px] -rotate-[5deg] flex flex-col gap-2 md:gap-8 px-4 md:px-8 lg:px-12 py-4 lg:py-8">
        <div className="text-2xl md:text-4xl monitor:text-6xl xl:text-5xl font-bold mb-2">
          Join our mailing list!
        </div>
        <p className="text-[#161616] mb-4 text-base md:text-xl lg:text-2xl monitor:text-3xl font-normal max-w-full md:max-w-[90%] leading-[140%]">
        ...
        <div className="flex justify-between items-start">
          <ul className="space-y-2 md:space-y-8 text-[#FF3044] font-bold text-base md:text-lg monitor:text-2xl xl:text-xl leading-[140%]">
