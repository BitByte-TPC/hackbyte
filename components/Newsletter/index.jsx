  ...
  return (
    <div className="w-full flex flex-col justify-center items-center gap-16 relative">
      ...
      <div className="bg-white rounded-[32px] absolute top-0 w-[80%] md:h-[500px] lg:h-[550px] -rotate-[5deg] flex flex-col gap-2 md:gap-8 px-4 md:px-8 lg:px-12 py-4 lg:py-8">
        <div className="text-2xl md:text-4xl xl:text-5xl font-bold mb-2">
          Join our mailing list!
        </div>
        <p className="text-[#161616] mb-4 text-base md:text-xl lg:text-2xl font-normal max-w-full md:max-w-[90%] leading-[140%]">
        ...
        <div className="flex justify-between items-start">
          <ul className="space-y-2 md:space-y-8 text-[#FF3044] font-bold text-base md:text-lg xl:text-xl leading-[140%]">
          ...
          <Image
            ...
            className="mt-12 lg:mt-16 xl:mt-20 md:w-40 lg:w-48 xl:w-64 hidden md:block"
          />
        </div>
      </div>
      ...
      <form
        ...
        className="w-[90%] md:w-[80%] my-4 md:my-16 pl-4 md:pl-8 pr-2 md:pr-4 py-2 md:py-4 bg-white rounded-[32px] justify-between items-center inline-flex"
      >
        <input
          className="text-supporting-mediumGray text-base md:text-2xl font-normal leading-[33px] w-full mr-4 focus:outline-none"
          type="text"
        ...
        <button
          type="submit"
          disabled={loading}
          className="text-white text-lg md:text-2xl font-bold leading-[33px] px-4 md:px-8 py-1 md:py-[12px] bg-[#ff3044] rounded-3xl"
        >
